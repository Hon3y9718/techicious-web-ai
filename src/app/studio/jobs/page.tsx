        ...
        <div className="flex items-center justify-between">
            <div>
             ...
             {/* <Link href="/studio/jobs/new">
                <Button disabled><PlusCircle className="mr-2 h-4 w-4" />New Job</Button>
            </Link> */}
        </div>
        <Card>
                        ...
                        <AlertDialog>
                           <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                               {/* <DropdownMenuItem disabled asChild><Link href={`/studio/jobs/edit/${job.id}`}><Pencil className="mr-2 h-4 w-4" />Edit</Link></DropdownMenuItem> */}
                           ...
                           <AlertDialogContent>
                            ...
                            <AlertDialogFooter><AlertDialogCancel>Cancel</AlertDialogCancel><AlertDialogAction onClick={() => handleDelete(job.id, job.title)} className="bg-destructive hover:bg-destructive/90">Delete</AlertDialogAction></AlertDialogFooter>
                          </AlertDialogContent>
                        </AlertDialog>
                      </TableCell>
                    </TableRow>
