    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        ...
        <section id="ai-capabilities" className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-br from-primary/10 to-background">
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-4 mb-12">
              <h2 className="text-3xl font-bold font-headline tracking-tighter sm:text-4xl md:text-5xl">Unlock the Future: Powered by <span className="animated-gradient-text text-4xl sm:text-5xl md:text-6xl">AI</span></h2>
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-lg">
