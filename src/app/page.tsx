    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        <section className="w-full py-20 md:py-32 lg:py-40 xl:py-48 bg-grid-slate-100/[0.05] dark:bg-grid-slate-900/[0.2] relative">
          <div className="absolute pointer-events-none inset-0 flex items-center justify-center bg-background [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] z-[-10] dark:z-auto"></div>
        ...
        <section id="ai-capabilities" className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-br from-primary/10 to-background">
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-4 mb-12">
              <h2 className="text-3xl font-bold font-headline tracking-tighter sm:text-4xl md:text-5xl">Unlock the Future: Powered by <span className="animated-gradient-text text-4xl sm:text-4xl md:text-5xl">AI</span></h2>
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-lg">
